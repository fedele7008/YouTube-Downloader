...
class LocaleKeys:
    ...
    SETTINGS_APPEARANCE_STYLE_TITLE = "settings-appearance-style-title"
    SETTINGS_APPEARANCE_STYLE_THEME_LABEL = "settings-appearance-style-theme-label"
    SETTINGS_APPEARANCE_STYLE_THEME_IMPORT_BUTTON = "settings-appearance-style-theme-import-button"
    SETTINGS_APPEARANCE_STYLE_PREVIEW_LABEL = "settings-appearance-style-preview-label"
    SETTINGS_APPEARANCE_FONT_TITLE = "settings-appearance-font-title"
